...
from models.feature_match import compute_feature_distances, match_features
...
def test_compute_dists():
    ...
    """
    feats1 = np.array([[0.707, 0.707], [-0.707, 0.707], [-0.707, -0.707]])
    feats2 = np.array([[-0.5, -0.866], [0.866, -0.5], [0.5, 0.866], [-0.866, 0.5]])
    dists = np.array(
        [
