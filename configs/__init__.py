"""Configuration module initialization for scene recognition project."""
...
config_block = yaml.dump(
    asdict(APP_CONFIG), indent=4, default_flow_style=False, sort_keys=False
)
