"""Simple neural network with dropout for scene recognition."""
...
class SimpleNetDropout(nn.Module):
    """A simple 2-layer CNN with dropout regularization for scene classification.

    This network extends SimpleNet by adding a dropout layer between the
    fully connected layers. Dropout randomly deactivates neurons during
    training to prevent overfitting.

    The network consists of:
    - Two convolutional layers with ReLU activation and max pooling
    - Two fully connected layers with dropout (p=0.5) between them
    """

    def __init__(self) -> None:
        """Initialize the SimpleNetDropout layers and loss function.
        ...
        # Convolutional layers (same as SimpleNet)
